// turning off error for "missing in props validation" to better see actual errors
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type='button' onClick={() => {content.reset(), info.reset(), author.reset()}}>reset</button>
